  ...
  <section class="form-section">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="form-control lg:col-span-2">
        <label class="label"><span class="label-text font-bold">ຊື່ອົງການ/ບໍລິສັດ: <span
        ...
        <label v-if="errors.companyName" class="label p-0 pt-1">
          <span class="label-text-alt text-error flex items-center gap-1"><span
              class="icon-[tabler--alert-circle] size-4"></span> {{ errors.companyName }}</span>
        </label>
      </div>

      <div class="form-control lg:col-span-2">
        <label class="label"><span class="label-text font-bold">ປະເພດຂອງທຸລະກິດ: <span
              class="text-error">*</span></span></label>
        ...
        <label v-if="errors.businessType" class="label p-0 pt-1">
          <span class="label-text-alt text-error flex items-center gap-1"><span
              class="icon-[tabler--alert-circle] size-4"></span> {{ errors.businessType }}</span>
        </label>
      </div>
      ...
      <div class="form-control">
        <label class="label"><span class="label-text font-bold">ເບີໂທບ່ອນເຮັດວຽກ: <span
              class="text-error">*</span></span></label>
      ...
      <div class="form-control">
        <label class="label"><span class="label-text font-bold">ອາຍຸການເຮັດວຽກ (ປີ): <span
              class="text-error">*</span></span></label>
        ...
        <label v-if="errors.workYears" class="label p-0 pt-1">
          <span class="label-text-alt text-error flex items-center gap-1"><span
              class="icon-[tabler--alert-circle] size-4"></span> {{ errors.workYears }}</span>
        </label>
      </div>
      ...
      <div class="form-control">
        ...
        <label v-if="errors.position" class="label p-0 pt-1">
          <span class="label-text-alt text-error flex items-center gap-1"><span
              class="icon-[tabler--alert-circle] size-4"></span> {{ errors.position }}</span>
        </label>
      </div>
      ...
      <div class="form-control lg:col-span-2">
        <label class="label"><span class="label-text font-bold">ເງິນເດືອນ/ລາຍຮັບຕໍ່ເດືອນ (ກີບ): <span
              class="text-error">*</span></span></label>
        <input :value="formatCurrencyInput(data.salary)"
          @input="handleCurrencyInput('salary', $event); errors.salary = ''" type="text" :readonly="!isEditing"
          class="input input-sm input-bordered w-full"
        ...
        <label v-if="errors.salary" class="label p-0 pt-1">
          <span class="label-text-alt text-error flex items-center gap-1"><span
              class="icon-[tabler--alert-circle] size-4"></span> {{ errors.salary }}</span>
        </label>
      </div>
...
const validateForm = (): boolean => {
  ...
  // 🌟 ແກ້ໄຂ: ປ່ຽນ companyAddress ເປັນ address ໃຫ້ໝົດ
...
defineExpose({ validateForm, errors });
</script>
